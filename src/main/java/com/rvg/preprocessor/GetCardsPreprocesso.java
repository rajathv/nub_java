 ...
 */
public class GetCardsPreprocesso implements DataPreProcessor2 {
    final Logger logger = LogManager.getLogger(GetCardsPreprocesso.class);
    ...
    public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
        ...
        String reqString = request.getParameter("customer_id");
        // String sessString = userAttributes.get("customer_id").toString();
