 ...
 */
public class GetAccountsPreprocessor implements DataPreProcessor2 {
    final Logger logger = LogManager.getLogger(GetAccountsPreprocessor.class);
    ...
    public boolean execute(HashMap inputMap, DataControllerRequest request, DataControllerResponse response,
        ...
        String reqString = request.getParameter("coreCustomerId");
